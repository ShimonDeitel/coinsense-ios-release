...
enum Reminders {
    private static let identifier = "coinsense.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "Your daily money lesson is ready"
        content.body = "One short lesson. Real financial habit. Tap to keep your streak."
